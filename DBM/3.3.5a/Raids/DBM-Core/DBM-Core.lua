...
-------------------------------
DBM = {
	Revision = ("$Revision: 3851 $"):sub(12, -3),
	Version = "4.44",
	DisplayVersion = "4.44", -- the string that is shown as version
	ReleaseRevision = 3851 -- the revision of the latest stable version that is available (for /dbm ver2)
}
